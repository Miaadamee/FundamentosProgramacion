...
# Ejercicio 9.
print("Ejercicio9. operadores de asignacion\n")

#ASIGNACION SIMPLE (=): Guardamos un valor en una variable 
puntos = 0 
print("Puntos inicales", puntos)
...
puntos *= 2
print("Puntos x2", puntos) #A Python no le gusto el mensaje que puse en el ejemplo
